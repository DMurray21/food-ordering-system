...
public class RestaurantMessagingDataMapper {
    ...
    orderApprovedEventToRestaurantApprovalResponseAvroModel(OrderApprovedEvent orderApprovedEvent) {
        return RestaurantApprovalResponseAvroModel.newBuilder()
                ...
                .setCreatedAt(orderApprovedEvent.getCreatedAt().toEpochSecond())
                .setOrderApprovalStatus(com.food.ordering.system.kafka.order.avro.model.OrderApprovalStatus.valueOf(orderApprovedEvent.
    ...
    orderRejectedEventToRestaurantApprovalResponseAvroModel(OrderRejectedEvent orderRejectedEvent) {
        return RestaurantApprovalResponseAvroModel.newBuilder()
                ...
                .setCreatedAt(orderRejectedEvent.getCreatedAt().toEpochSecond())
    ...
    restaurantApprovalRequestAvroModelToRestaurantApproval(RestaurantApprovalRequestAvroModel
        ...
        return RestaurantApprovalRequest.builder()
                ...
                .createdAt(Instant.ofEpochMilli(restaurantApprovalRequestAvroModel.getCreatedAt()))
                .build();
    }
}
