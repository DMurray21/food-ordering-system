...
import com.food.ordering.system.restaurant.service.domain.ports.input.message.listener.RestaurantApprovalMessageListener;
...
@Slf4j
@Component
public class RestaurantApprovalKafkaRequestListener implements KafkaConsumer<RestaurantApprovalRequestAvroModel> {

    private final RestaurantApprovalMessageListener restaurantApprovalRequestMessageListener;
    private final RestaurantMessagingDataMapper restaurantMessagingDataMapper;

    public RestaurantApprovalKafkaRequestListener(RestaurantApprovalMessageListener
