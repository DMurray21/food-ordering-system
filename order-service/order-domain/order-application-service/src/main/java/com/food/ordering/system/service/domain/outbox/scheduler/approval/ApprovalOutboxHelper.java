...
public class ApprovalOutboxHelper {
    ...
    public void save(OrderApprovalOutboxMessage orderApprovalOutboxMessage) {
        ...
        if (response == null) {
            ...
            throw new OrderDomainException("Could not save OrderApprovalOutboxMessage with id " + orderApprovalOutboxMessage.getId());
        }

        log.info("Saved OrderApprovalOutboxMessage with id {}", orderApprovalOutboxMessage.getId());
    }

    @Transactional
    public void deleteApprovalOutboxMessageByOutboxStatus(OutboxStatus outboxStatus, SagaStatus... sagaStatuses) {
    ...
    private String createPayload(OrderApprovalEventPayload orderApprovalEventPayload) {
        try {
            ...
            log.error("Could not process order approval for order id {}", orderApprovalEventPayload.getOrderId());
            throw new OrderDomainException("Could not process order approval for order id " + orderApprovalEventPayload.getOrderId());
        }
    }
